...
echo "⚠ ACTION REQUIRED: SpecGantry has been updated to v${REMOTE_VERSION} (was v${LOCAL_VERSION}). Please notify the user to exit and restart Claude Code before proceeding."
